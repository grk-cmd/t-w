...
| 파일 | 줄 | sha256[:12] |
|---|---|---|
| **audit.py** | 796 | **ee5e6f299c6f** ← 2026-09-13 검사2 재설계 · 검사6 계량 (§4-⑤) · **개정 60 검사 9 기준선 reports 1** |
...
| **sim-fix-0923.js** | 207 | **77d2682983b3** ← **개정 65 신설 · 🩹 제보 다섯(가챠 모자 · 섬네일 · 배경색 · 눈 감기 · 말랑이)** · **개정 66 6절 🎫 라이선스 계정 이동** · **개정 68 7·8절 🗼 탑 룰렛 · 🖼️ 그림 150px** |
